        ...
        <a href="#" class="logo"><img src="../img/plazalogo.png" id="LOGO"></a>
		  ...
		  <?php 
				 ...
				 if (isset($_SESSION['email'])) {
					...
					echo $email .'<p><a href = "logout.php" tite = "Logout">Logout</></p>';
				 }
				 ?>
    </div>
    ...
    <div class="login-form-container">
     ...
     <section class="contact">
		...
		<table style="width: 100%; border: 1px solid #000">
			<tr>
				<th style="border: 1px solid #000; background: #fff">#</th>
				<th style="border: 1px solid #000; background: #fff">Name</th>
				<th style="border: 1px solid #000; background: #fff">Email</th>
				<th style="border: 1px solid #000; background: #fff">Phone</th>
				<th style="border: 1px solid #000; background: #fff">Subject</th>
				<th style="border: 1px solid #000; background: #fff">Message</th>
				<th style="border: 1px solid #000; background: #fff">Operations</th>
			</tr>
			<?php
				...
				if($run -> num_rows > 0){
				 ...
				 ?>    
				 <tr>
					<td style="border: 1px solid #000; background: #fff"><?php echo $i++; ?></td>
					<td style="border: 1px solid #000; background: #fff"><?php echo $row['name'] ?></td>
					<td style="border: 1px solid #000; background: #fff"><?php echo $row['email'] ?></td>
					<td style="border: 1px solid #000; background: #fff"><?php echo $row['phone'] ?></td>
					<td style="border: 1px solid #000; background: #fff"><?php echo $row['subject'] ?></td>
					<td style="border: 1px solid #000; background: #fff"><?php echo $row['message'] ?></td>
